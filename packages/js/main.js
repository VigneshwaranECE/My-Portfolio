...
const sendEmail = (params) => {
  const serviceID = "service_zm3nsmi";
  const templateID = "template_zzztxuc";

  emailjs
    .send(serviceID, templateID,params,"ESlueyIXbI7lRU1tH")
    .then((res) => {
...
const validateEmail = (email, params) => {
  const apiKey = "d06e67bb9ec846f68d6deb06865e2cdf";
...
document.getElementById("contact-form").addEventListener("submit", (e) => {
  ...
  const params = { to_name: name, from_email: email, message: message };
